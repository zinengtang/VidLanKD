...
def process_args():
    ...
    # VLM related params
    parser.add_argument("--voken_model_dir", type=str, default='snap1/coco_hinge05_dim64_resxt101_robertal4/vokens',
                        help='Where the vokens are saved')
    parser.add_argument("--do_kd1_objective", action='store_true', help='Will do voken regre task')
    parser.add_argument("--do_kd2_objective", action='store_true', help='Will do voken classification task')
