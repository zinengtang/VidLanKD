...
#     model_weights = torch.load('snap/bert/wiki_bert_base/checkpoint-epoch0000/pytorch_model.bin')
#     model_weights = torch.load('snap/vlm/wiki103_bert_small_vokenmmd_vokencrd/checkpoint-epoch0012/pytorch_model.bin')
#     model_weights = torch.load('snap/vlm/wiki103_bert_small_vokenmmd_image/checkpoint-epoch0017/pytorch_model.bin')
#     model.load_state_dict(model_weights, strict=False)

    if args.do_kd1_objective or args.do_kd2_objective:
        vteacher = VteacherBert(config=config)
#         model_weights = torch.load('snap/vlm/howto100m_bert_small_nomlm/checkpoint-epoch0046/pytorch_model.bin')
        
#         model_weights = torch.load('snap/vlm/howto100m_bert_base_vokenhinge_v1/checkpoint-epoch0017/pytorch_model.bin')
#         model_weights = torch.load('snap/vlm/howto100m_bert_small_vokencontrastive/checkpoint-epoch0015/pytorch_model.bin')
        model_weights = torch.load('snap/vlm/howto100m_bert_small_vokenhinge_v1/checkpoint-epoch0015/pytorch_model.bin')
#         model_weights = torch.load('snap/vlm/howto100m_bert_small_vokenhinge_image/checkpoint-epoch0018/pytorch_model.bin')
